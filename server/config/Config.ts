...
export module Config {
    export class Server {
        ...
        public static PasswordSalt:string = 'I^F^y_UmK~G^=1i+xPi|t1_lSOiq~+~La=CvE1Yeh4V~izp~4AnEDVixy4R|'; //Changing will break entire password database
        public static TokenSalt:string = 'RO^zMe1jFN%9L9BgNlP~LJqOvN15ZCAv9lct-+uIgDZWsnaNks0%ZKw3guul'; //Changing will invalidate all currently valid tokens
