...
export module Data {
    ...
    export interface IMongoRepository<T> {
        //Read
        FindById(id:string, requestContext:any, callback:(data:T, errors:ErrorsModel.Model.ClientErrorsModel) => void): void;
        FindByCondition(condition:any, requestContext:any, callback:(data:T[], errors:ErrorsModel.Model.ClientErrorsModel) => void): void;
        FindPaged(condition:any, page:number, size:number, requestContext:any,
                  callback:(pagedData:any, errors:ErrorsModel.Model.ClientErrorsModel) => void): void;
        FindByConditionAndProject(condition:any, projector:any, requestContext:any,
        ...
        //Delete
        Delete(id:string, requestContext:any, callback:(success:boolean, errors:ErrorsModel.Model.ClientErrorsModel) => void): void;
